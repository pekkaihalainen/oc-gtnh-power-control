...
IMPORTANT: The energy storage adapter must be placed directly adjacent to your 
supercapacitor controller to access its energy methods!
--]]

local config = {}

-- REQUIRED: Set these to your actual component addresses
config.ENERGY_STORAGE_ADDRESS = "your-energy-storage-address-here"
